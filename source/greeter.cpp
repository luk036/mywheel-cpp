 ...
 * `LanguageCode::EN`, the function will return a greeting message in English. If the `lang`
 * parameter is `LanguageCode::DE`, the function will return a greeting message in German. If the
 * `lang
 */
